...
hyperparameters_config = {
    '--lr': {'default': 0.096506, 'metavar': '-l', 'type': float, 'help': 'learning rate'},
    '--l2_reg': {'default': 0.000367, 'metavar': '-r', 'type': float, 'help': 'L2 regularization factor (weight decay)'},
    '--epochs': {'default': 200, 'metavar': '-e', 'type': int, 'help': 'Number of training epochs'},
    '--dropout': {'default': 0.869203, 'metavar': '-d', 'type': float, 'help': 'Dropout regularization'},
    '--momentum': {'default': 0.728434, 'metavar': '-m', 'type': float, 'help': 'SGD Momentum'},
